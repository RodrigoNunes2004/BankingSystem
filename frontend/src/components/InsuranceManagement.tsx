...
const InsuranceManagement: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"products" | "policies" | "quotes" | "claims">("products");
  ...
  const mockProducts: InsuranceProduct[] = [
    {
      ...
      type: "life",
      description: "Comprehensive life insurance with flexible terms and competitive rates",
      coverage: "Death benefit, terminal illness, accidental death",
      premium: 45,
      coverageAmount: 500000,
      term: "20-30 years",
      features: ["Term life coverage", "Accelerated death benefit", "No medical exam option", "Convertible to permanent"],
      icon: "🛡️",
      color: "#28a745",
      isPopular: true
    },
    {
      ...
      type: "health",
      description: "Complete health coverage with low deductibles and extensive network",
      coverage: "Medical, dental, vision, prescription drugs",
      premium: 180,
      coverageAmount: 1000000,
      term: "Annual renewable",
      features: ["Low deductible", "Extensive provider network", "Prescription coverage", "Preventive care"],
      icon: "🏥",
      color: "#007bff",
      isPopular: true
    },
    {
      ...
      type: "auto",
      description: "Full coverage auto insurance with roadside assistance and rental car",
      coverage: "Liability, collision, comprehensive, uninsured motorist",
      premium: 120,
      coverageAmount: 100000,
      term: "6 months",
      features: ["Full coverage", "Roadside assistance", "Rental car coverage", "Accident forgiveness"],
      icon: "🚗",
      color: "#ffc107"
    },
    {
      ...
      coverage: "Dwelling, personal property, liability, additional living expenses",
      premium: 95,
      coverageAmount: 400000,
      term: "Annual",
      features: ["Full replacement cost", "Personal liability", "Additional living expenses", "Natural disaster coverage"],
      icon: "🏠",
      color: "#6f42c1"
    },
    {
      ...
      type: "travel",
      description: "International travel insurance with medical coverage and trip protection",
      coverage: "Medical expenses, trip cancellation, baggage loss, emergency evacuation",
      premium: 25,
  ...
  const getProductFeatures = (type: string) => {
    const features = {
      life: ["Death benefit", "Terminal illness coverage", "Accelerated benefits", "No medical exam option"],
      health: ["Medical coverage", "Prescription drugs", "Preventive care", "Mental health"],
      auto: ["Liability coverage", "Collision coverage", "Comprehensive coverage", "Roadside assistance"],
      home: ["Dwelling coverage", "Personal property", "Liability protection", "Additional living expenses"],
      travel: ["Medical expenses", "Trip cancellation", "Baggage protection", "Emergency evacuation"]
    };
  ...
  const purchasePolicy = async (productId: number) => {
    try {
      ...
      alert(`Policy application submitted! Policy Number: ${newPolicy.policyNumber}`);
    } catch (err) {
  ...
  if (loading) return <div className="loading">Loading insurance products...</div>;
        ...
        <div className="products-container">
          ...
          <div className="products-grid">
            {products.map(product => (
              <div key={product.id} className={`product-card ${product.isPopular ? 'popular' : ''}`}>
                ...
                <div className="product-pricing">
                  ...
                  <div className="coverage">
                    ...
                    <span className="value">${product.coverageAmount.toLocaleString()}</span>
                  </div>
                </div>
                ...
                <div key={policy.id} className="policy-card">
                  <div className="policy-header">
                    <div className="policy-icon">
                      {getTypeIcon(products.find(p => p.id === policy.productId)?.type || "")}
                    </div>
                  ...
                  <div className="policy-details">
                    <div className="detail-row">
                      ...
                      <span className="value">${policy.coverageAmount.toLocaleString()}</span>
                    </div>
                    <div className="detail-row">
                    ...
                    <div className="detail-row">
                      ...
                      <span className="value">{policy.startDate} - {policy.endDate}</span>
                    </div>
                    <div className="detail-row">
                      <span className="label">Next Payment:</span>
                      <span className="value">{new Date(policy.nextPaymentDate).toLocaleDateString()}</span>
                    </div>
                  </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, productType: e.target.value as any})}
                  required
                >
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, age: parseInt(e.target.value)})}
                  min="18"
                  max="80"
                  required
                />
            ...
            {quoteRequest.productType === "life" && (
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, term: parseInt(e.target.value)})}
                >
            ...
            {quoteRequest.productType === "health" && (
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, healthStatus: e.target.value as any})}
                >
            ...
            {quoteRequest.productType === "auto" && (
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, drivingRecord: e.target.value as any})}
                >
            ...
            {quoteRequest.productType === "home" && (
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setQuoteRequest({...quoteRequest, propertyValue: parseInt(e.target.value)})}
                  min="100000"
                  step="10000"
                />
              </div>
            ...
            {quoteResult && (
              <div className="quote-result">
                ...
                <div className="quote-features">
                  <h5>Coverage Includes:</h5>
                  <ul>
                    {quoteResult.features.map((feature: string, index: number) => (
                      <li key={index}>{feature}</li>
                    ))}
                  </ul>
                </div>
