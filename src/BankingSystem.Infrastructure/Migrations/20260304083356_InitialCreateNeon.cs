        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvertedAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrencyExchanges_Accounts_FromAccountId",
                        column: x => x.FromAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CurrencyExchanges_Accounts_ToAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrencyExchanges_FromAccountId",
                table: "CurrencyExchanges",
                column: "FromAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_CurrencyExchanges_ToAccountId",
                table: "CurrencyExchanges",
                column: "ToAccountId");
